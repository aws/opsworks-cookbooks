...
default['opsworks_java']['tomcat']['lib_dir_ext'] = "/usr/share/tomcat#{node['opsworks_java']['tomcat']['base_version']}/lib/ext"
default['opsworks_java']['tomcat']['java_shared_lib_dir'] = '/usr/share/java'
default['opsworks_java']['tomcat']['java_shared_lib_dir_ext'] = '/usr/share/java/ext'
